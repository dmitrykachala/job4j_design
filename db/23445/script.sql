...
begin;
    declare curs_prod cursor for select * from products;
    fetch last from curs_prod;
    move backward 4 from curs_prod;
    fetch prior from curs_prod;
    move backward 7 from curs_prod;
    fetch prior from curs_prod;
    move backward 4 from curs_prod;
    fetch prior from curs_prod;
    fetch first from curs_prod;
    close curs_prod;
commit;